...
column1 = dbc.Col([
            ...
            Based on data available from 1946 till 2019, the model can predict outcome with 67.4% accuracy.

            """), dcc.Link(dbc.Button('My Case Prediction', color='primary'), href='/predictions')], md=4, )
