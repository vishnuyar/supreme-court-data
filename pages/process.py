...
model_interpreation = dbc.Row(
    [
    dbc.Col(
        html.Div('Intrepreting the Model',style={'text-align': 'center','font-size':24,'font-weight':'bold','margin-top':'20px;'})
    )
    ]
)
...
partialplot_heading  = dbc.Row([
    dbc.Col(
        html.Div('Partila plot for Issue Area',style={'text-align': 'center','font-size':16,'font-weight':'bold'})
    ),
    dbc.Col(
        html.Div('Partila plot for Cert Reason',style={'text-align': 'center','font-size':16,'font-weight':'bold'})
    )
...
partialplot = dbc.Row([
    ...
    #     ),
    dbc.Col(
        html.Img(src='/assets/partialplot_issuearea.png',style={'width':'100%','height':'100%'})
        ),
    dbc.Col(
        html.Img(src='/assets/partialplot_certreason.png',style={'width':'100%','height':'100%'})
        )
